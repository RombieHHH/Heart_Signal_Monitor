 ...
 * contains the QRS energy-envelope peak index (filter/envelope delay included).
 * ECGMonitor refines this to a display-waveform R extremum before computing RR.
 * No history buffer is allocated by this detector itself. */
